...
public class StudentController {
	...
	public String newStudent(@ModelAttribute("studentForm") Student student,BindingResult bindingResult) {
		logger.info("update/add student");
